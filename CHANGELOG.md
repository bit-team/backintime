...
- New '--usage' option added to the 'show' subcommand to display the total physical disk usage of all backups in a profile
  ([PR#2480](https://github.com/bit-team/backintime/pull/2480))
- Dependencies:
