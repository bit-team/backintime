...
Problem might be introduced in `1.5.*` or `1.6.*`. There is no clear solution
to the problem. Also the real cause is still unknown. The plan is to re-write
that widget from scratch. See
