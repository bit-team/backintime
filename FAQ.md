...
- [Backups (snapshots)](#backups-snapshots)
   ...
   * [How to use extended filesystem attributes (xattr) to exclude files/directories](#how-to-use-extended-filesystem-attributes-xattr-to-exclude-files-directories)
- [Restore](#restore)
